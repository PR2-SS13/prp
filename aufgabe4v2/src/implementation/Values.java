...
public final class Values {
    ...
    public static Container container(UniqueId id) {
        return ContainerImpl.valueOf(id);
    }
    ...
    public static Stowage palletStowage(int bays, int rows, int tiers, Mass maxMass) {
        return PalletStowageImpl.valueOf(bays, rows, tiers, maxMass);
    }
